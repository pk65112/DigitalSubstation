...
import NewProjectLine from './NewProjectLine';
...
const LineConstructionHome = (props) => {
    ...
    <View style={styles.sectionContainer}>
      ...
      <View style={[styles.portion2, { flex: 3 }]}>
        ...
        <TouchableHighlight activeOpacity={0.6} style={styles.iconset}
          onPress={() => props.navigation.navigate('NewProjectLine', { NewProjectLine })}>
        ...
        <TouchableHighlight activeOpacity={0.6} style={styles.iconset}
          onPress={() => props.navigation.navigate('Notice', { Notice })}>
          <View style={{ alignItems: 'center' }}>
...
export default LineConstructionHome;